...
class BackgroundTasks(commands.Cog):
    ...
    async def check_users(self):
        ...
        if online == 2:
            raise Exception("We have 2 online users")
    ...
    async def before_check__users(self):
        logger.warn("Before check_users")

    @check_users.after_loop
    async def after_check__users(self):
        logger.warn("After stopping the loop")
